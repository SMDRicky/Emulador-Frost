...
struct s_laphine_creation;
struct s_laphine_options;
...
// [RomuloSM]: Battleground Fake Guild
...
int clif_equiphide(struct block_list *bl, va_list ap); // @clif_equiphide [Bad]
