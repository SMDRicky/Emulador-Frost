...
// eAthena additions
	...
	int restock_enable;
	int restock_vip_type;
	int restock_group_level;
	int restock_regular_max_items;
	int restock_vip_max_items;
	int restock_max_stack;
	int restock_charge_oncmd;
	int restock_regular_zeny_cost;
	int restock_vip_zeny_cost;
	int restock_maps;	
	...
	int bg_reward_enable;
	int bg_check_dual;
	int bg_ranking_rows;
	int bg_castle_defense;
	int bg_interface;
	int bg_skip_accept;
	int bg_clothes1color;
	int bg_clothes2color;

	// [RomuloSM]: Player Info
	int playerinfo_equip_item;
	int playerinfo_guild_item;
	int playerinfo_bg_item;
	int playerinfo_ranked_item;
	...
	int pvpmode_dropbonus;
	int pvpmode_mutepenalty;
	int pvpmode_exppenalty;
	int pvpmode_expreward;
	int pvpmode_nowarp_cmd;
	int pvpmode_enable_delay;
	int pvpmode_disable_delay;
	int pvpmode_short_damage_rate;
	int pvpmode_long_damage_rate;
	int pvpmode_weapon_damage_rate;
	int pvpmode_magic_damage_rate;
	int pvpmode_misc_damage_rate;
	int pvpmode_flee_penalty;
	int pvpmode_city_only;

	int petsecurity_item;
	...
	int extended_stall_enable;
	int extended_stall_broadcast;
	int extended_stall_showboard;
	int extended_stall_showtotal;

	// [RomuloSM]: Extended Search Store
	int extended_searchstore_enable;

	// [RomuloSM]: Extended Buying Store
	int extended_buyingstore_enable;
	int extended_buyingstore_showboard;

	// [RomuloSM]: Player Bot
	int player_bot_hpbar_green;
