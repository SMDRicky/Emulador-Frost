...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(MF_EQUIP_HIDE);
	export_constant(MF_NOEQUIP_OFF);
	...
	export_constant(MF_NOSTALL);

	// PvP Mode
	export_constant(MF_NO_PVPMODE);
	export_constant(MF_FORCED_PVPMODE);
	...
	export_constant(CELL_CHKNOSTALL);
	...
	export_constant(SC_FARM_PREMIUM);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_EQUIP_HIDE);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	// [RomuloSM]: Player Bot
	export_constant(UMOB_DEADSIT);
	export_constant(UMOB_PLAYER_BOT);
	export_constant(UMOB_JOBLEVEL);
	...
	export_constant(INF2_NOPVPMODE);	// PvP Mode
	...
	/* refine costs types */
	export_constant(REFINECOST_ZENY);
	export_constant(REFINECOST_ORIDECON);
	export_constant(REFINECOST_ELUNIUM);
	export_constant(REFINECOST_PHRACON);
	export_constant(REFINECOST_EMVERETARCON);
	...
	export_constant(MAX_RESTOCK);
	export_constant(MF_RESTOCK_ON);
	export_constant(MF_RESTOCK_OFF);
	...
	// Aplly Results
	export_constant(BG_APPLY_NONE);
	export_constant(BG_APPLY_ACCEPT);
	export_constant(BG_APPLY_QUEUE_FINISHED);
	export_constant(BG_APPLY_INVALID_NAME);
	export_constant(BG_APPLY_INVALID_APP);
	export_constant(BG_APPLY_PLAYER_COUNT);
	export_constant(BG_APPLY_PLAYER_LEVEL);
	export_constant(BG_APPLY_DUPLICATE);
	export_constant(BG_APPLY_RECONNECT);
	export_constant(BG_APPLY_PARTYGUILD_LEADER);
	export_constant(BG_APPLY_PLAYER_CLASS);

	// Queue Info
	// [RomuloSM]: Battleground Expansion
	export_constant(MF_NOBGSKILLCALL);
	export_constant(MF_NOBGRESPAWN);
	export_constant(MF_BGHAPPYHOUR);
	export_constant(MF_NOBGHAPPYHOUR);
	export_constant(CELL_NOBGBATTLE);
	export_constant(CELL_NOBGSKILLCALL);
	export_constant(CELL_CHKNOBGBATTLE);
	export_constant(CELL_CHKNOBGSKILLCALL);
	// Battleground Team
	export_constant2("BG_TEAM_A", 0);
	export_constant2("BG_TEAM_B", 1);
	// Battleground Channel
	export_constant(CHAN_TYPE_BG);
	// Battleground Rewards
	export_constant(BGRW_ALL);
	export_constant(BGRW_WINNER);
	export_constant(BGRW_LOSER);
	export_constant(BGRW_DRAW);
	// Battleground statistic
	export_constant(BGR_WINS);
	export_constant(BGR_LOSS);
	export_constant(BGR_TIED);
	export_constant(BGR_SCORE_WINS);
	export_constant(BGR_SCORE_LOSS);
	export_constant(BGR_SKILLSUP_SUCCESS);
	export_constant(BGR_SKILLSUP_FAIL);
	export_constant(BGR_SKILLUSE_SUCCESS);
	export_constant(BGR_SKILLUSE_FAIL);
	export_constant(BGR_SKILLDMG_GIVEN);
	export_constant(BGR_SKILLDMG_TAKEN);
	export_constant(BGR_HEAL_HP);
	export_constant(BGR_HEAL_SP);
	export_constant(BGR_ITEMHEAL_HP);
	export_constant(BGR_ITEMHEAL_SP);
	export_constant(BGR_ITEMHEAL);
	export_constant(BGR_AMMO);
	export_constant(BGR_POISON_BOTTLE);
	export_constant(BGR_FIRE_BOTTLE);
	export_constant(BGR_ACID_BOTTLE);
	export_constant(BGR_ORIDECON);
	export_constant(BGR_ELUNIUM);
	export_constant(BGR_STEEL);
	export_constant(BGR_EMVERETARCON);
	export_constant(BGR_WOODEN_BLOCK);
	export_constant(BGR_STONE);
	export_constant(BGR_YELLOW_GEMSTONE);
	export_constant(BGR_RED_GEMSTONE);
	export_constant(BGR_BLUE_GEMSTONE);
	export_constant(BGR_PLAYER_KILL);
	export_constant(BGR_PLAYER_DEATH);
	export_constant(BGR_PLAYER_DMG_GIVEN);
	export_constant(BGR_PLAYER_DMG_TAKEN);
	export_constant(BGR_RUNESTONE_KILL);
	export_constant(BGR_RUNESTONE_DMG);
	export_constant(BGR_RUNESTONE_REPAIR);
	export_constant(BGR_EMPERIUM_KILL);
	export_constant(BGR_EMPERIUM_DMG);
	export_constant(BGR_BARRICADE_KILL);
	export_constant(BGR_BARRICADE_DMG);
	export_constant(BGR_BARRICADE_REPAIR);
	export_constant(BGR_OBJECTIVE_KILL);
	export_constant(BGR_OBJECTIVE_DMG);
	export_constant(BGR_FLAG_KILL);
	export_constant(BGR_FLAG_DMG);
	export_constant(BGR_FLAG_CAPTURE);
	export_constant(BGR_FLAG_RECAPTURE);
	export_constant(BGR_CRYSTAL_KILL);
	export_constant(BGR_CRYSTAL_DMG);
	export_constant(BGR_GUARD_KILL);
	export_constant(BGR_GUARD_DEATH);
	export_constant(BGR_GUARD_DMG_GIVEN);
	export_constant(BGR_GUARD_DMG_TAKEN);
	export_constant(BG_QUEUE_ID);
	export_constant(BG_QUEUE_NAME);
	export_constant(BG_QUEUE_ARENA_NAME);
	export_constant(BG_QUEUE_REQUIRED_PLAYERS);
	export_constant(BG_QUEUE_ACCEPTED_PLAYERS);
	export_constant(BG_QUEUE_MAX_PLAYERS);
	export_constant(BG_QUEUE_MIN_LEVEL);
	export_constant(BG_QUEUE_MAX_LEVEL);
	export_constant(BG_QUEUE_STATE);
	export_constant(BG_QUEUE_TEAMA_SIZE);
	export_constant(BG_QUEUE_TEAMB_SIZE);

	// Queue State
	export_constant(QUEUE_STATE_SETUP);
	export_constant(QUEUE_STATE_SETUP_DELAY);
	export_constant(QUEUE_STATE_ACTIVE);
	export_constant(QUEUE_STATE_ENDED);
	...
	// [RomuloSM]: Stuff Type
	export_constant(IS_TYPE_NONE);
	export_constant(IS_TYPE_BG);
	export_constant(IS_TYPE_GVG);
	export_constant(IS_TYPE_PVP);
	...
	export_constant(MAX_CASHPOINT);
	export_constant(VENDING_BANK_SELL);
	export_constant(VENDING_BANK_BUYINGSOTORE);
	export_constant(VENDING_BANK_STALL_SELL);
	export_constant(VENDING_BANK_STALL_BUYINGSTORE_OK);
	export_constant(VENDING_BANK_STALL_BUYINGSTORE_FAIL);
